...
(function(root) {
  ...
  function injectLegacyStyles() {
    ...
    style.textContent += '.legacy-toast{top:16px;right:auto;bottom:auto;left:50%;transform:translateX(-50%);animation:legacy-toast-drop .25s cubic-bezier(.16,1,.3,1)}@keyframes legacy-toast-drop{from{opacity:0;transform:translateX(-50%) translateY(-32px)}to{opacity:1;transform:translateX(-50%) translateY(0)}}@media (prefers-reduced-motion:reduce){.legacy-toast{animation:none}}';
  }
  ...
  function showLegacyToast(event) {
    ...
    root.setTimeout(function() { if (toast.parentNode) toast.remove(); }, 5000);
  }
