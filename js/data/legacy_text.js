// Centralized long-form legacy and end-of-career copy constants.

var CHAMPION_CELEBRATION_TEXT = [
...
var JERSEY_RETIREMENT_TEAM_IDS = [
  'ATL', 'BOS', 'BKN', 'CHA', 'CHI', 'CLE', 'DAL', 'DEN', 'DET', 'GSW',
  'HOU', 'IND', 'LAC', 'LAL', 'MEM', 'MIA', 'MIL', 'MIN', 'NOP', 'NYK',
  'OKC', 'ORL', 'PHI', 'PHX', 'POR', 'SAC', 'SAS', 'TOR', 'UTA', 'WAS'
];
var JERSEY_RETIREMENT_TEXT_BY_TEAM = {};

var JERSEY_RETIREMENT_TEXT_FALLBACK = [
    ...
    "球衣升上屋顶那刻，你没有抬头。{achievement}。你怕自己一看，就会想起太多事。{team}的 {years} 年，有胜利，有拥抱，也有许多没人替你保管的普通日子，最后它们一起升上去，变成这座城市的记忆。",
    "{team}选择退役你的球衣，不是奖励一段数据，而是承认一段关系。{achievement}。你在{team}的 {years} 年，让很多球迷有了一个可以对后来人反复提起的名字。",
];

JERSEY_RETIREMENT_TEAM_IDS.forEach(function(teamId) {
  JERSEY_RETIREMENT_TEXT_BY_TEAM[teamId] = JERSEY_RETIREMENT_TEXT_FALLBACK.slice();
});
...
var TOP100_TEXT = [
    "联盟公布新版历史百大球星，你的名字被放进名单。{achievement}。年轻球迷开始回看你的集锦，老球迷则争论你到底该排第几。无论争论如何，有一件事已经确定：你的生涯不只是被记住，而是被放进历史。",
    ...
    "你入选了联盟历史百大。{achievement}。{teamList}的球迷都觉得自己有份，因为每一站你都留下过让他们骄傲的夜晚。",
    ...
    "你入选联盟历史百大，媒体开始盘点你的名场面。{achievement}。你最想让他们盘点的，是那些没人看见的训练馆清晨。",
    ...
    "你入选联盟历史百大的消息，让{lastTeam}的街角球馆贴满了海报。{achievement}。那里的孩子第一次知道：从这片球场出发，可以走到历史里。",
...
var TOP100_FAIL_TEXT = [
    "新版联盟历史百大球星名单公布，你没有进入最终名单。但媒体仍把你称为一个时代的重要名字：不是所有传奇都需要排名证明。{achievement}。",
    ...
    "你没有进入百大，但你把{firstTeam}的孩子带进了职业联盟。{achievement}。有些历史不写在名单上，写在下一代人的球衣上。",
...
var RETIREMENT_TEXT = [
    ...
    "你举起话筒，说：我今天想讲一个关于梦想的故事。{achievement}。你说：有个孩子，梦想着打职业联赛。后来他打了，而且打了{seasonsCount} 年。今天，他退役了，但他想告诉所有孩子：梦想，是可以实现的。",
    ...
    "你举起话筒，说：我今天想讲一个关于“第一次”的故事。{achievement}。你说：第一次摸到篮球，第一次进球，第一次进入职业联盟，第一次夺冠。今天，我第一次退役。每一个第一次，我都记得。",
    ...
    "你讲起自己第一次穿国家队球衣，说那一刻你觉得自己代表的不是自己。{achievement}。你说：那种感觉，和打职业联赛不一样，但同样重。今天退役了，那份重量还在。",
