...
(() => {
  ...
  var EVENT_META = {
    ...
    onload: { label: "\u9875\u9762\u52A0\u8F7D", category: "page" },
    access: { label: "\u8BBF\u95EE", category: "page" },
    videoact: { label: "\u89C6\u9891\u64CD\u4F5C", category: "other" },
    onPageOpen: { label: "\u9875\u9762\u6253\u5F00", category: "page" },
    onPageClose: { label: "\u9875\u9762\u5173\u95ED", category: "page" }
  };
  ...
  function track(params) {
    ...
    const next = Object.assign({ act: "onload", pg: globalState.pageTrackCode }, params || {});
