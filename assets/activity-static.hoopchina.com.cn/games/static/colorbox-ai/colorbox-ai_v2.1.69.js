(function () {
  ...
  (() => {
    ...
    `;
      ...
      if (document.body) initializeDebugger();else document.addEventListener("DOMContentLoaded", initializeDebugger, {
        once: true
      });
    }
    ...
    function track(params) {
      ...
      const next = Object.assign({
        act: "onload",
        pg: globalState.pageTrackCode
      }, params || {});
      if (typeof window !== "undefined" && window.location && window.location.search) {
        const hasDebugFlag = name => new RegExp("(?:^|[?&])" + name + "=true(?:&|$)").test(window.location.search);
        if (hasDebugFlag("debug") || hasDebugFlag("sensors_debug") || hasDebugFlag("colorbox_debug")) {
          console.info("%c[ColorboxAI.Track]%c 触发埋点上报\n事件数据:", "color: white; background: #2563eb; padding: 2px 6px; border-radius: 4px;", "color: #3b82f6; font-weight: bold;", next);
      ...
      const hpTracerWhitelist = ["onload", "click", "exposure", "videoact", "access", "onPageOpen", "onPageClose"];
      ...
      if (isWhitelisted) {
        ...
        try {
          ...
          if (isIOS && window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.ClientBridge) {
            ...
            window.androidBridge.callNativeAsync("hupu.common.hermes", JSON.stringify({
              code: 200,
              data: payload.data
            }));
          } else {
  ...
  (() => {
      ...
      function request(method, url, body, invoke) {
        return __async(this, null, function* () {
          ...
          if (guard.maxCallsPerEndpointWindow > 0 && endpointCalls.length >= guard.maxCallsPerEndpointWindow) {
            ...
            const message = `\u540C\u4E00\u9875\u9762\u540C\u63A5\u53E3 ${Math.round(guard.endpointWindowMs / 1000)} \u79D2\u5185\u8BF7\u6C42\u8D85\u8FC7 ${guard.maxCallsPerEndpointWindow} \u6B21\uFF0C\u5DF2\u963B\u6B62\u672C\u6B21\u8BF7\u6C42`;
            const detail = {
              endpointUrl,
            ...
            if (shouldLog) {
              ...
              state.endpointLimitErrors.set(endpointKey, {
                mutedUntil
              });
            ...
            if (guard.maxCallsPerUrlWindow > 0 && urlCalls.length >= guard.maxCallsPerUrlWindow) {
              ...
              if (!urlLimitLogged) {
                emitRequestGuardLog({
                  ...
                  code: 429,
                  message: `\u540C URL ${Math.round(guard.urlWindowMs / 1000)} \u79D2\u5185\u8BF7\u6C42\u8D85\u8FC7 ${guard.maxCallsPerUrlWindow} \u6B21\uFF0C\u5DF2\u6392\u961F\u7B49\u5F85`,
                  detail: {
    ...
    function createColorboxBbsApi() {
      ...
      const guardedHttpClient = createGuardedHttpClient("legacy.bbs", void 0, {
        get: (url, config) => requestJson(url, Object.assign({
          method: "GET"
        }, config)),
        post: (url, body, config) => requestJson(url, Object.assign({
          method: "POST",
          body
        }, config))
      });
    ...
    function createColorboxSecurityApi() {
      ...
      function checkAuditViaParent(content) {
        return new Promise(function (resolve, reject) {
          ...
          const callbackId = "sec_" + Date.now() + "_" + Math.floor(Math.random() * 1000000);
          const record = {
            resolve,
            reject,
          ...
          postMessageToParent("security.checkAudit", {
            content,
            callbackId
          });
        });
  ...
  (() => {
    ...
    function createColorboxStorageApi(options) {
      options = options || {};
      const MAX_STORAGE_BYTES = 204800;
      ...
      function parseStorageValue(value, scopedKey) {
        ...
        if (typeof value !== "string") {
          logInfo("[ColorboxAI.Storage.Parse] input is not a string, returning directly", {
            type: typeof value
          });
          return value;
        }
      ...
      function createCallbackName(type) {
        return "_colorbox_ai_storage_" + type + "_" + Date.now() + "_" + Math.floor(Math.random() * 1000000) + "_";
      }
      function createHupuJsBridgeCallbackName(type) {
        return "_hupu_bridge_" + type + "_" + Date.now() + Math.floor(Math.random() * 1000) + "_";
      }
      ...
      function ensureHupuJsBridgeChannel() {
        ...
        if (hupuJsBridgePreviousBridge && typeof hupuJsBridgePreviousBridge.bridgePatch === "function") {
          ...
          hupuJsBridgePreviousBridge.bridgePatch({
            _handle_: handleHupuJsBridgeCallback
          });
        } else {
          ...
          return new Promise(function (resolve, reject) {
            ...
            try {
              ...
              if (window.androidBridge && window.androidBridge.callNativeAsync) {
                window.androidBridge.callNativeAsync(method, JSON.stringify({
                  code: 200,
                  data: data || {}
                }), successcb);
                if (fireAndForget) {
      ...
      function readBridgeValue(scopedKey) {
        logInfo("[ColorboxAI.Storage.readBridgeValue] querying bridge, key: " + scopedKey, {
          scopedKey
        });
        return callClientBridge("hupu.common.getValue", {
          keys: [scopedKey]
        }, {
      ...
      function writeBridgeValues(payload) {
        ...
        return callClientBridge("hupu.common.setValue", payload, {
          fireAndForget: true
  ...
  window.ColorboxAI.security = window.ColorboxAI.security || {
    checkAudit: function (params) {
      return window.ColorboxAI.__security.checkAudit(params);
    }
  };
  ...
  window.ColorboxAI.score = window.ColorboxAI.score || {
    getScore: function (params) {
      return window.ColorboxAI.__score.getScore(params);
    },
    addScore: function (params) {
      return window.ColorboxAI.__score.addScore(params);
    },
    listByBizKeys: function (params) {
      return window.ColorboxAI.__score.listByBizKeys(params);
    }
  };
  ...
  window.ColorboxAI.storage = window.ColorboxAI.storage || {
    setValue: function (params) {
      return window.ColorboxAI.__storage.setValue(params);
    },
    getValue: function (params) {
      return window.ColorboxAI.__storage.getValue(params);
    }
  };
...
(() => {
  ...
  var require_dist = __commonJS({
    "../../node_modules/.pnpm/parse-url@9.2.0/node_modules/parse-url/dist/index.js"(exports, module) {
      ...
      var normalizeDataURL = (urlString, {
        stripHash
      }) => {
  ...
  var require_cjs = __commonJS({
    "../../node_modules/.pnpm/@hupu+shared@0.0.12/node_modules/@hupu/shared/cjs/index.js"(exports, module) {
          ...
          case "index":
            {
              return function (key) {
                return function (result, value) {
                  ...
                  if (value === null) {
                    return _to_consumable_array(result).concat([[encode(key, options), "[", index, "]"].join("")]);
                  }
                  return _to_consumable_array(result).concat([[encode(key, options), "[", encode(index, options), "]=", encode(value, options)].join("")]);
                };
              };
            }
          case "bracket":
            {
              return function (key) {
                return function (result, value) {
                  ...
                  if (value === null) {
                    return _to_consumable_array(result).concat([[encode(key, options), "[]"].join("")]);
                  }
                  return _to_consumable_array(result).concat([[encode(key, options), "[]=", encode(value, options)].join("")]);
                };
              };
            }
          case "colon-list-separator":
            {
              return function (key) {
                return function (result, value) {
                  ...
                  if (value === null) {
                    return _to_consumable_array(result).concat([[encode(key, options), ":list="].join("")]);
                  }
                  return _to_consumable_array(result).concat([[encode(key, options), ":list=", encode(value, options)].join("")]);
                };
              };
            }
          case "comma":
          ...
          default:
            {
              return function (key) {
                return function (result, value) {
                  ...
                  if (value === null) {
                    return _to_consumable_array(result).concat([encode(key, options)]);
                  }
                  return _to_consumable_array(result).concat([[encode(key, options), "=", encode(value, options)].join("")]);
                };
              };
          ...
          case "bracket":
            {
              return function (key, value, accumulator) {
                ...
                accumulator[key] = _to_consumable_array(accumulator[key]).concat([value]);
              };
            }
          case "colon-list-separator":
            {
          ...
          default:
            {
              return function (key, value, accumulator) {
                ...
                accumulator[key] = _to_consumable_array([accumulator[key]].flat()).concat([value]);
              };
            }
        }
      }
      ...
      function parse(query, options) {
        ...
        try {
          for (var _iterator = query.split("&")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var _splitOnFirst = _sliced_to_array(splitOnFirst(parameter_, "="), 2),
              key = _splitOnFirst[0],
      ...
      function parseUrl(url, options) {
        ...
        var _splitOnFirst = _sliced_to_array(splitOnFirst(url, "#"), 2),
          url_ = _splitOnFirst[0],
          hash = _splitOnFirst[1];
        if (url_ === void 0) {
          url_ = url;
        }
        var _url__split_;
      ...
      var getEnv = function () {
        ...
        if (isValidUrl(url)) {
          var _ref = (0, import_parse_url.default)(url),
            href = _ref.href,
            hostname = _ref.host,
            search = _ref.search;
        ...
        var ProxyClass = new Proxy(Constructor, {
          ...
          construct: function construct(_target, newArgs) {
            if (instance) {
              ...
              (_instance_setConfig1 = instance.setConfig) === null || _instance_setConfig1 === void 0 ? void 0 : (_instance_setConfig = _instance_setConfig1).call.apply(_instance_setConfig, [instance].concat(_to_consumable_array(newArgs)));
              return instance;
            }
      ...
      function request(options) {
        return new Promise(function (resolve, reject) {
          var url = options.url,
            _options_method = options.method,
            method = _options_method === void 0 ? "POST" : _options_method,
            _options_headers = options.headers,
            headers = _options_headers === void 0 ? {
              "Content-Type": "application/json"
            } : _options_headers,
            timeout = options.timeout,
            data = options.data,
            _options_withCredentials = options.withCredentials,
            withCredentials = _options_withCredentials === void 0 ? true : _options_withCredentials;
      ...
      var createInteractionModule = function (send, _register) {
        return {
          ...
          showToast: function (_param) {
            var _param_duration = _param.duration,
              duration = _param_duration === void 0 ? 2000 : _param_duration,
              params = _object_without_properties(_param, ["duration"]);
  ...
  function acquireCapabilityPermit(state, capabilityPath, guard) {
    return __async(this, null, function* () {
      while (true) {
        let now = Date.now();
        const calls = compactWindow(state.capabilityCalls.get(capabilityPath) || [], now, 60000);
        ...
        const minuteWaitMs = hasMinuteBudget || guard.maxCallsPerMinute <= 0 ? void 0 : Math.max((calls[0] || now) + 60000 - now + 1, 1);
  ...
  function executor2(params, context) {
    return __async(this, null, function* () {
      ...
      if (!hupuToken) {
        return {
          code: 401,
          message: "未获取到虎扑登录态（x-hupu-token）",
          data: null
        };
      }
      const loginResp = yield postJson(DEFAULT_LOGIN_URL, {}, {
  ...
  function executor3(params, context) {
    return __async(this, null, function* () {
      ...
      let body;
      if (method === "GET") {
        finalUrl = appendQuery(finalUrl, params.data && typeof params.data === "object" ? params.data : null);
  ...
  function executor4(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.url)) {
        return {
          code: 400,
          message: "Missing parameters: url is required",
          data: null
        };
      }
      const win2 = typeof window !== "undefined" ? window : {};
  ...
  function sendIframeBridgeMessage(type, payload) {
    ...
    return new Promise((resolve, reject) => {
      var _a, _b;
      const callbackId = `${type.replace(/\./g, "_")}_cb_${Date.now()}_${Math.floor(Math.random() * 1000000)}`;
  ...
  function callApi(_0, _1) {
    return __async(this, arguments, function* (url, context, options = {}) {
        ...
        if (hasDirectBridge) {
          try {
            ...
            const bridgeParams = __spreadValues({
              ...
              data: requestData,
              header: headers
            }, options.postContentType ? {
              postContentType: options.postContentType
            } : {});
      ...
      try {
        ...
        const res = method === "GET" ? yield context.httpClient.get(finalUrl, {
          headers
        }) : yield context.httpClient.post(finalUrl, options.body, {
          headers
        });
        return {
          code: 200,
  ...
  function executor6(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.activityId)) {
        return {
          code: 400,
          message: "Missing parameter: activityId is required",
          data: null
        };
      }
  ...
  function executor7(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.bizKeys) || !Array.isArray(params.bizKeys) || params.bizKeys.length === 0) {
        return {
          code: 400,
          message: "Missing or empty parameter: bizKeys is required",
          data: null
        };
      }
      try {
        ...
        const headers = {};
        if (token) headers["X-Hupu-Token"] = token;
        const res = yield context.httpClient.post(url, payload, {
          headers
        });
        return res;
      } catch (err) {
  ...
  function executor8(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.activityId) || !(params == null ? void 0 : params.groupId) || !(params == null ? void 0 : params.itemId)) {
        return {
          code: 400,
          message: "Missing parameters: activityId, groupId, and itemId are required",
          data: null
        };
      }
  ...
  function executor9(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.leagueType)) {
        return {
          code: 400,
          message: "Missing parameter: leagueType",
          data: null
        };
      }
  ...
  function executor13(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.topic_id)) {
        return {
          code: 400,
          message: "Missing parameter: topic_id is required",
          data: null
        };
      }
      const version = context.env.getAppVersion() || "8.2.53";
  ...
  function executor14(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.tid)) {
        return {
          code: 400,
          message: "Missing parameter: tid is required",
          data: null
        };
      }
      const version = context.env.getAppVersion() || "8.2.53";
      ...
      if (res.code === 200 && res.data) {
        ...
        if (rawData && typeof rawData.id === "number" && typeof rawData.text === "string") {
          ...
          res.data = __spreadProps(__spreadValues({}, coercedData), {
            list: Array.isArray(coercedData.list) ? coercedData.list : []
          });
        }
      }
      return res;
  ...
  function executor15(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.topicId)) {
        return {
          code: 400,
          message: "Missing parameter: topicId is required",
          schema: ""
        };
      }
      try {
  ...
  function isIosRuntime(context) {
    ...
    const nativeText = [nativeInfo.platform, nativeInfo.os, nativeInfo.osType, nativeInfo.system, nativeInfo.device, nativeInfo.model, nativeInfo.client].filter(Boolean).join(" ");
  ...
  function executor16(params, context) {
    return __async(this, null, function* () {
      ...
      if (typeof params.content !== "string" || !params.content.trim()) {
        return {
          code: 400,
          message: "Missing parameter: content is required",
          data: null
        };
      }
      const version = context.env.getAppVersion() || "8.2.53";
  ...
  function executor20(params, context) {
    return __async(this, null, function* () {
      ...
      if (!bid) {
        return {
          code: 400,
          message: "Missing parameter: battleId",
          data: null
        };
      }
      const version = context.env.getAppVersion() || DEFAULT_HUPU_APP_VERSION;
  ...
  function executor21(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.matchType)) {
        return {
          code: 400,
          message: "Missing parameter: matchType",
          data: null
        };
      }
      const version = context.env.getAppVersion() || DEFAULT_HUPU_APP_VERSION;
  ...
  function executor25(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.standingsId)) {
        return {
          code: 400,
          message: "Missing parameter: standingsId",
          data: null
        };
      }
      const version = context.env.getAppVersion() || "8.0.0";
  ...
  function executor27(params, context) {
    return __async(this, null, function* () {
      ...
      if (!(params == null ? void 0 : params.tagCode)) {
        return {
          code: 400,
          message: "Missing parameter: tagCode",
          data: null
        };
      }
      const apiParams = {
  ...
  function executor29(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.newsId)) {
        return {
          code: 400,
          message: "Missing parameter: newsId",
          data: null
        };
      }
      const version = context.env.getAppVersion() || DEFAULT_HUPU_APP_VERSION;
  ...
  function executor30(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.teamId)) {
        return {
          code: 400,
          message: "Missing parameter: teamId",
          data: null
        };
      }
      if (!(params == null ? void 0 : params.category)) {
  ...
  function executor31(params, context) {
    return __async(this, null, function* () {
      ...
      const res = yield callApi(params.url, context, __spreadValues({
        ...
        params: reqData && typeof reqData === "object" ? reqData : {}
      } : {
        body: reqData
      }));
  ...
  function executor32(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.outBizType) || !(params == null ? void 0 : params.outBizNo) || (params == null ? void 0 : params.score) == null) {
        return {
          code: 400,
          message: "Missing parameters: outBizType, outBizNo and score are required",
          data: null
        };
      }
      try {
  ...
  function executor33(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.outBizType) || !(params == null ? void 0 : params.outBizNo)) {
        return {
          code: 400,
          message: "Missing parameters: outBizType and outBizNo are required",
          data: null
        };
      }
      try {
        ...
        const headers = {};
        if (token) headers["X-Hupu-Token"] = token;
        const res = yield context.httpClient.get(url, {
          headers
        });
        return res;
      } catch (err) {
  ...
  function executor34(params, context) {
    return __async(this, null, function* () {
      ...
      if (inIframe && hasParentShellBridge) {
        try {
          const payload = yield sendIframeBridgeMessage("security.checkAudit", {
            content
          });
      ...
      try {
        ...
        const headers = {};
        if (token) headers["X-Hupu-Token"] = token;
        const res = yield context.httpClient.post(url, {
          content,
          title: ""
        }, {
          headers
      ...
      if (params.errorcb) {
        ...
        if (typeof fn === "function") {
          try {
            fn.call(null, {
              code: 430,
              message: "Bridge unsupported in current environment"
            });
          } catch (e) {
  ...
  function executor35(params, context) {
    return __async(this, null, function* () {
      if (!(params == null ? void 0 : params.title) || !(params == null ? void 0 : params.link)) {
        return {
          code: 400,
          message: "Missing parameters: title and link are required",
          data: null
        };
      }
  ...
  function executor37(params, context) {
    return __async(this, null, function* () {
      ...
      if (!data || typeof data !== "object" || Array.isArray(data)) {
        return {
          ok: false,
          message: "Invalid storage payload: object data is required"
        };
      }
      const storage = (_a = win2.ColorboxAI) == null ? void 0 : _a.__storage;
  ...
  function executor38(params, context) {
    return __async(this, null, function* () {
      ...
      if (!trackParams) {
        return {
          ok: false,
          message: "Missing parameters: track data is required"
        };
      }
    ...
    const rawHttpClient = {
      get: (url, config) => {
        if (typeof cb.__requestJson === "function") {
          return cb.__requestJson(url, Object.assign({
            method: "GET"
          }, config));
        }
  ...
  win.ColorboxAI.auth.getUserInfo = params => executor(params, getContext("auth.getUserInfo", {
    "enabled": false
  }));
  win.ColorboxAI.cloud = win.ColorboxAI.cloud || {};
  win.ColorboxAI.cloud.auth = params => executor2(params, getContext("cloud.auth", {
    "enabled": false
  }));
  win.ColorboxAI.cloud = win.ColorboxAI.cloud || {};
  win.ColorboxAI.cloud.request = params => executor3(params, getContext("cloud.request", {
    "enabled": false
  }));
  win.ColorboxAI.navigate = win.ColorboxAI.navigate || {};
  win.ColorboxAI.navigate.to = params => executor4(params, getContext("navigate.to", {
    "enabled": false
  }));
  win.ColorboxAI.oss = win.ColorboxAI.oss || {};
  win.ColorboxAI.oss.uploadFile = params => executor5(params, getContext("oss.uploadFile", {
    "enabled": false
  }));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.activity = win.ColorboxAI.request.activity || {};
  win.ColorboxAI.request.activity.getVoteDetail = params => runCapabilityWithRequestGuard("request.activity.getVoteDetail", {
    "enabled": true
  }, () => executor6(params, getContext("request.activity.getVoteDetail", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.activity = win.ColorboxAI.request.activity || {};
  win.ColorboxAI.request.activity.listByBizKeys = params => runCapabilityWithRequestGuard("request.activity.listByBizKeys", {
    "enabled": true
  }, () => executor7(params, getContext("request.activity.listByBizKeys", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.activity = win.ColorboxAI.request.activity || {};
  win.ColorboxAI.request.activity.submitVote = params => runCapabilityWithRequestGuard("request.activity.submitVote", {
    "enabled": true
  }, () => executor8(params, getContext("request.activity.submitVote", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.basketball = win.ColorboxAI.request.basketball || {};
  win.ColorboxAI.request.basketball.playerInfo = params => runCapabilityWithRequestGuard("request.basketball.playerInfo", {
    "enabled": true
  }, () => executor9(params, getContext("request.basketball.playerInfo", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.basketball = win.ColorboxAI.request.basketball || {};
  win.ColorboxAI.request.basketball.singleMatch = params => runCapabilityWithRequestGuard("request.basketball.singleMatch", {
    "enabled": true
  }, () => executor10(params, getContext("request.basketball.singleMatch", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.bbs = win.ColorboxAI.request.bbs || {};
  win.ColorboxAI.request.bbs.detail = params => runCapabilityWithRequestGuard("request.bbs.detail", {
    "enabled": true
  }, () => executor11(params, getContext("request.bbs.detail", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.bbs = win.ColorboxAI.request.bbs || {};
  win.ColorboxAI.request.bbs.getTagThreadList = params => runCapabilityWithRequestGuard("request.bbs.getTagThreadList", {
    "enabled": true
  }, () => executor12(params, getContext("request.bbs.getTagThreadList", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.bbs = win.ColorboxAI.request.bbs || {};
  win.ColorboxAI.request.bbs.getTopicThreads = params => runCapabilityWithRequestGuard("request.bbs.getTopicThreads", {
    "enabled": true
  }, () => executor13(params, getContext("request.bbs.getTopicThreads", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.bbs = win.ColorboxAI.request.bbs || {};
  win.ColorboxAI.request.bbs.getsThreadPostList = params => runCapabilityWithRequestGuard("request.bbs.getsThreadPostList", {
    "enabled": true
  }, () => executor14(params, getContext("request.bbs.getsThreadPostList", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.bbs = win.ColorboxAI.request.bbs || {};
  win.ColorboxAI.request.bbs.openPostEditor = params => runCapabilityWithRequestGuard("request.bbs.openPostEditor", {
    "enabled": true
  }, () => executor15(params, getContext("request.bbs.openPostEditor", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.bbs = win.ColorboxAI.request.bbs || {};
  win.ColorboxAI.request.bbs.replyPost = params => runCapabilityWithRequestGuard("request.bbs.replyPost", {
    "enabled": true
  }, () => executor16(params, getContext("request.bbs.replyPost", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.football = win.ColorboxAI.request.football || {};
  win.ColorboxAI.request.football.liveRoomNewsList = params => runCapabilityWithRequestGuard("request.football.liveRoomNewsList", {
    "enabled": true
  }, () => executor17(params, getContext("request.football.liveRoomNewsList", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.football = win.ColorboxAI.request.football || {};
  win.ColorboxAI.request.football.matchInfo = params => runCapabilityWithRequestGuard("request.football.matchInfo", {
    "enabled": true
  }, () => executor18(params, getContext("request.football.matchInfo", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.football = win.ColorboxAI.request.football || {};
  win.ColorboxAI.request.football.playerInfo = params => runCapabilityWithRequestGuard("request.football.playerInfo", {
    "enabled": true
  }, () => executor19(params, getContext("request.football.playerInfo", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.kog = win.ColorboxAI.request.kog || {};
  win.ColorboxAI.request.kog.playbyplay = params => runCapabilityWithRequestGuard("request.kog.playbyplay", {
    "enabled": true
  }, () => executor20(params, getContext("request.kog.playbyplay", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.liveTab = win.ColorboxAI.request.liveTab || {};
  win.ColorboxAI.request.liveTab.infoList = params => runCapabilityWithRequestGuard("request.liveTab.infoList", {
    "enabled": true
  }, () => executor21(params, getContext("request.liveTab.infoList", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.liveTab = win.ColorboxAI.request.liveTab || {};
  win.ColorboxAI.request.liveTab.list = params => runCapabilityWithRequestGuard("request.liveTab.list", {
    "enabled": true
  }, () => executor22(params, getContext("request.liveTab.list", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.lol = win.ColorboxAI.request.lol || {};
  win.ColorboxAI.request.lol.playbyplay = params => runCapabilityWithRequestGuard("request.lol.playbyplay", {
    "enabled": true
  }, () => executor23(params, getContext("request.lol.playbyplay", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.match = win.ColorboxAI.request.match || {};
  win.ColorboxAI.request.match.getTabDetailScheduleList = params => runCapabilityWithRequestGuard("request.match.getTabDetailScheduleList", {
    "enabled": true
  }, () => executor24(params, getContext("request.match.getTabDetailScheduleList", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.match = win.ColorboxAI.request.match || {};
  win.ColorboxAI.request.match.queryAllDiagramInfoById = params => runCapabilityWithRequestGuard("request.match.queryAllDiagramInfoById", {
    "enabled": true
  }, () => executor25(params, getContext("request.match.queryAllDiagramInfoById", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.match = win.ColorboxAI.request.match || {};
  win.ColorboxAI.request.match.queryMatchStatsByMatchInfo = params => runCapabilityWithRequestGuard("request.match.queryMatchStatsByMatchInfo", {
    "enabled": true
  }, () => executor26(params, getContext("request.match.queryMatchStatsByMatchInfo", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.news = win.ColorboxAI.request.news || {};
  win.ColorboxAI.request.news.newsCommonList = params => runCapabilityWithRequestGuard("request.news.newsCommonList", {
    "enabled": true
  }, () => executor27(params, getContext("request.news.newsCommonList", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.news = win.ColorboxAI.request.news || {};
  win.ColorboxAI.request.news.playerNewsList = params => runCapabilityWithRequestGuard("request.news.playerNewsList", {
    "enabled": true
  }, () => executor28(params, getContext("request.news.playerNewsList", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.news = win.ColorboxAI.request.news || {};
  win.ColorboxAI.request.news.subjectNews = params => runCapabilityWithRequestGuard("request.news.subjectNews", {
    "enabled": true
  }, () => executor29(params, getContext("request.news.subjectNews", {
    "enabled": true
  })));
  win.ColorboxAI.request = win.ColorboxAI.request || {};
  win.ColorboxAI.request.news = win.ColorboxAI.request.news || {};
  win.ColorboxAI.request.news.teamNewsList = params => runCapabilityWithRequestGuard("request.news.teamNewsList", {
    "enabled": true
  }, () => executor30(params, getContext("request.news.teamNewsList", {
    "enabled": true
  })));
  var oldReq = win.ColorboxAI.request;
  win.ColorboxAI.request = params => runCapabilityWithRequestGuard("request", {
    "enabled": true
  }, () => executor31(params, getContext("request", {
    "enabled": true
  })));
  Object.assign(win.ColorboxAI.request, oldReq);
  win.ColorboxAI.score = win.ColorboxAI.score || {};
  win.ColorboxAI.score.addScore = params => runCapabilityWithRequestGuard("score.addScore", {
    "enabled": true
  }, () => executor32(params, getContext("score.addScore", {
    "enabled": true
  })));
  win.ColorboxAI.score = win.ColorboxAI.score || {};
  win.ColorboxAI.score.getScore = params => runCapabilityWithRequestGuard("score.getScore", {
    "enabled": true
  }, () => executor33(params, getContext("score.getScore", {
    "enabled": true
  })));
  win.ColorboxAI.security = win.ColorboxAI.security || {};
  win.ColorboxAI.security.checkAudit = params => executor34(params, getContext("security.checkAudit", {
    "enabled": false
  }));
  win.ColorboxAI.social = win.ColorboxAI.social || {};
  win.ColorboxAI.social.share = params => executor35(params, getContext("social.share", {
    "enabled": false
  }));
  win.ColorboxAI.storage = win.ColorboxAI.storage || {};
  win.ColorboxAI.storage.getValue = params => executor36(params, getContext("storage.getValue", {
    "enabled": false
  }));
  win.ColorboxAI.storage = win.ColorboxAI.storage || {};
  win.ColorboxAI.storage.setValue = params => executor37(params, getContext("storage.setValue", {
    "enabled": false
  }));
  win.ColorboxAI.track = win.ColorboxAI.track || {};
  win.ColorboxAI.track.report = params => executor38(params, getContext("track.report", {
    "enabled": false
  }));
